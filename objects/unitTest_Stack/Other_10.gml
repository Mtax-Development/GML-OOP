...
#region [Test: Construction: New constructor / Method: destroy()]
	...
	var _result = [ds_exists(constructor.ID, ds_type_stack)];
...
#region [Test: Value write/read]
	...
	var _expectedValue = [_value[2], _value[1], _value[0]];
...
#region [Test: Construction: Wrapper]
	...
	var _element = ds_stack_create();
	var _value = [33333, "ABC", -2.095];
	
	ds_stack_push(_element, _value[0], _value[1], _value[2]);
	
	constructor = new Stack(_element);
...
#region [Test: Construction: Constructor copy]
	...
	constructor[1] = new Stack(constructor[0]);
...
#region [Test: Method: isFunctional()]
	...
	constructor = [new Stack(), new Stack()];
	constructor[1].destroy();
...
#region [Test: Method: copy()]
	...
	var _expectedValue = [_value[0][1], _value[0][0]];
...
#region [Test: Method: forEach()]
	...
	var _expectedValue = [[_value[5], _value[3]]];
...
#region [Test: String conversion]
	...
	var _expectedValue = (constructorName + "(" + string(_value[2]) + ", " + string(_value[1]) +
						  ", " + string(_value[0]) + ")");
...
#region [Test: Method: toString(lenght cut)]
	...
	var _expectedValue = (constructorName + "(" + _value[1] + _element[0][1] + ")");
...
#region [Test: Method: toString(multiline)]
	...
	constructor = new Stack();
	constructor.add(_value[2], _value[1], _value[0]);
...
#region [Test: Methods: fromArray() / toArray()]
	...
	constructor = [new Stack(), new Stack()];
	constructor[0].add(_value[0], _value[1], _value[2]);
	constructor[1].fromArray(constructor[0].toArray(), true);
