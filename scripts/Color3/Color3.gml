...
//  @feather	ignore all
{
  #region [Methods]
   ...
   #region <Getters>
	...
	/// @argument			other {Color3}
	/// @argument			value {real}
	/// @returns			{Color3} | On error: {undefined}
	...
	static interpolate = function(_other, _value)
	{
		try
		{
			...
			return new Color3(_color1, _color2, _color3);
		}
		catch (_exception)
		{
   ...
   #region <Setters>
	...
	/// @description		Set all of color values to the ones of the specified value or first three
