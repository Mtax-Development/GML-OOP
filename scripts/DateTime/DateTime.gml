...
//  @feather	ignore all
{
  #region [Methods]
			...
			else
			{
				...
				else if (is_array(argument[0]))
				{
					if ((argument_count > 1) and (is_array(argument[1])))
					{
						...
						ID = date_create_datetime(_array_date[0], _array_date[1], _array_date[2],
												  _array_time[0], _array_time[1], _second);
						year = date_get_year(ID);
						month = date_get_month(ID);
						week = date_get_week(ID);
						day = date_get_day(ID);
					...
					else
					{
						...
						var _year = _array[0];
						var _month = (((_array_length > 1) and (_array[1] != undefined)) ? _array[1]
																						 : 1);
						var _day = (((_array_length > 2) and (_array[2] != undefined)) ? _array[2]
																					   : 1);
						var _hour = (((_array_length > 3) and (_array[3] != undefined)) ? _array[3]
																						: 0);
						var _minute = (((_array_length > 4) and (_array[4] != undefined)) ? _array[4]
																						  : 0);
						var _second = (((_array_length > 5) and (_array[5] != undefined)) ? _array[5]
																						  : 0);
				...
				else
				{
					...
					var _day = argument[2];
					var _hour = (((argument_count > 3) and (argument[3] != undefined)) ? argument[3]
																					   : 0);
					var _minute = (((argument_count > 4) and (argument[4] != undefined)) ? argument[4]
																						 : 0);
					var _second = (((argument_count > 5) and (argument[5] != undefined)) ? argument[5]
																						 : 0);
   ...
   #region <Getters>
	...
	/// @description		Compare this and a specified DateTime to check which is first. Returns -1
	///						if this date is earlier, 0 if even or 1 if later.
	...
	/// @argument			other {DateTime}
	/// @returns			{int} | On error: {undefined}
	/// @description		Compare date components of this and a specified DateTime to check which is
	///						first. Returns -1 if this date is earlier, 0 if even or 1 if later.
	...
	/// @argument			other {DateTime}
	/// @returns			{int} | On error: {undefined}
	/// @description		Compare time components of this and a specified DateTime to check which is
	///						first. Returns -1 if this time is earlier, 0 if even or 1 if later.
	...
	/// @description		Return the number of years between this and a specified DateTime.
	///						Incomplete years will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{real} | On error: {undefined}
	/// @description		Return the number of months between this and a specified DateTime.
	///						Incomplete months will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{real} | On error: {undefined}
	/// @description		Return the number of weeks between this and a specified DateTime.
	///						Incomplete weeks will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{real} | On error: {undefined}
	/// @description		Return the number of days between this and a specified DateTime.
	///						Incomplete days will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{real} | On error: {undefined}
	/// @description		Return the number of hours between this and a specified DateTime.
	///						Incomplete hours will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{real} | On error: {undefined}
	/// @description		Return the number of minutes between this and a specified DateTime.
	///						Incomplete minutes will be returned as a fraction.
	...
	/// @argument			other {DateTime}
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of seconds between this and a specified DateTime.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the date component of this DateTime.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the time component of this DateTime.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of days in the year of the date component.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of days in the month of the date component.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of which week in the year the date component is,
	///						starting from 0.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of which day in the year the date component is.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of which hour in the year the date component is.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of which minute in the year the date component is.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the number of which second in the year the date component is.
	...
	/// @returns			{int} | On error: {undefined}
	/// @description		Return the day count in the week of the date component, starting from 0
	///						and treating Sunday as the frist day of the week.
	...
	/// @description		Check if the date component is the same as local date on the device, using
	///						the set timezone.
	...
	/// @returns			{bool} | On error: {undefined}
	/// @description		Check if the date component is a leap year. It is a calendar year with
	///						an additional day in February in comparison to a common year, with purpose
	///						of synchronizing seasonal and astronomical years.
   ...
   #region <Setters>
	...
	/// @description		Modify any component of this DateTime by specified numbers.
	static modify = function(_years = 0, _months = 0, _days = 0, _hours = 0, _minutes = 0,
							 _seconds = 0)
	{
		if (is_real(ID))
		{
		...
		else
		{
			ErrorReport.report([other, self, "modify()"],
							   ("Attempted to modify an invalid date: " + "{" + string(ID) + "}"));
		}
	...
	/// @argument			number {int}
	/// @description		Modify the years of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the months of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the weeks of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the days of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the hours of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the minutes of this DateTime by the specified number.
	...
	/// @argument			value {int}
	/// @description		Modify the seconds of this DateTime by the specified number.
	...
	/// @description		Set this DateTime to the current of the system using the set timezone.
   ...
   #region <Conversion>
		...
		if (ID != undefined)
		{
			if (_full)
			{
				...
				var _string = ("Date: " + self.toStringDate() + _mark_separator +
							   ...
							   "Is leap year: " + string(self.isLeapYear()) + _mark_separator +
							   "Weekday: " + string(self.getWeekday()) + _mark_separator +
							   "Days in year: " + string(self.getDaysInYear()) + _mark_separator +
							   "Days in month: " + string(self.getDaysInMonth()) + _mark_separator +
							   "Week of year: " + string(self.getWeekOfYear()) + _mark_separator + 
							   "Day of year: " + string(self.getDayOfYear()) + _mark_separator +
							   "Hour of year: " + string(self.getHourOfYear()) + _mark_separator +
							   "Minute of year: " + string(self.getMinuteOfYear())+ _mark_separator +
	...
	/// @description		Return all elements of this DateTime as an array, ordered from the longest
	///						units of time to the shortest.
	...
	/// @returns			{int[]|undefined[]}
	/// @description		Return all elements of the date component as an array, ordered from the
	///						longest units of time to the shortest.
	...
	/// @returns			{int[]|undefined[]}
	/// @description		Return all elements of the time component as an array, ordered from the
	///						longest units of time to the shortest.
