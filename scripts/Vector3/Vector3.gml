...
//  @feather	ignore all
{
  #region [Methods]
   #region <Management>
	...
	{
		return ((is_real(x)) and (is_real(y)) and (is_real(z)) and (!is_nan(x)) and (!is_nan(y)) and
				(!is_nan(z)) and (!is_infinity(x)) and (!is_infinity(y)) and (!is_infinity(z)));
	}
   ...
   #region <Getters>
	...
	///						number or respective values of other Vector3. Those values can be
	...
	/// @argument			value {real|Vector3}
	/// @returns			{bool}
	/// @description		Check if all values of this Vector3 are higher than the specified value
	///						or respective values of the specified Vector3.
	...
	/// @argument			value {real|Vector3}
	/// @returns			{bool}
	/// @description		Check if all values of this Vector3 are lower than the specified value or
	///						respective values of the specified Vector3.
	...
	/// @description		Return the result of respectively adding the values of this Vector3 to the
	///						specified value or its own properties if the value is not specified.
	static sum = function()
	{
		try
		{
	...
	/// @description		Return the result of respectively substracting the specified value from
	///						the values of this Vector3.
	...
	/// @argument			value? {real|Vector3}
	/// @returns			{real|Vector3} | On error: {undefined}
	/// @description		Return the difference using values of this Vector3. If a value was
	///						specified, a Vector3 containing the differences between their respective
	///						values will be returned. Otherwise, a number representing the difference
	///						between values of this Vector3 will be returned. This calculation ignores
	...
	/// @argument			value? {real|Vector3}
	/// @returns			{real|Vector3} | On error: {undefined}
	/// @description		Return the result of respectively multiplying the values of this Vector3
	...
	/// @argument			value {real|Vector3}
	/// @returns			{Vector3} | On error: {undefined}
	/// @description		Return the result of respectively dividing the values of this Vector3 by
	///						the specified value, ignoring division by 0.
	...
	/// @description		Return the sum of each value of this and other Vector3 being multiplied by
	///						their respective other value, which is an expression of the angular
	///						relationship between its two points. The returned value can be normalized,
	///						which will place it between -1 and 1.
	...
	/// @argument			other {Vector3}
	/// @returns			{Vector3} | On error: {undefined}
	/// @description		Return the difference between values of this Vector3 multiplied by values
	///						of different axes of the specified Vector3, which is an expression of the
	///						normal plane relationship between two points.
	...
	/// @argument			other {Vector3}
	/// @returns			{real}
	/// @description		Return the shortest distance between this and the specified Vector3.
	...
	/// @returns			{Vector3}
	/// @description		Return the unit vector of this Vector3, which will have its values placed
	///						between -1 and 1, but with the same direction. These values are then
	///						multiplied by the specified magnitude. If this operation would be invalid,
	///						a directionless vector will be returned.
	...
	/// @returns			{Vector3} | On error: {undefined}
	/// @description		Return a Vector3 with each respective value representing the sign of the
   ...
   #region <Setters>
	...
	/// @argument			value {real|Vector3}
	/// @description		Substract the specified value from the respective values of this Vector3.
	...
	/// @argument			value {real|Vector3}
	/// @description		Divide respective values of this Vector3 by the specified value, ignoring
	///						division by 0.
	...
	/// @description		Move all values towards the specified target with respective rate without
	///						exceeding it.
	...
	///						values with the same sign as the values of this Vector3.
	...
	///						respective values with the same sign as the values of this Vector3.
	...
	/// @description		Set all of the values to one specified value or first three values of the
	///						specified array.
   ...
   #region <Conversion>
	...
	static toString = function(_multiline = false)
	{
		...
		var _string = ("x: " + string(x) + _mark_separator + "y: " + string(y) + _mark_separator +
					   "z: " + string(z));
