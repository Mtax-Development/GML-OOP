...
///						last-in-first-out model, which disallows order manipulation.
//						
//						Construction types:
//						- New constructor
...
//  @feather	ignore all
{
  #region [Methods]
   ...
   #region <Getters>
	...
	/// @description		Return the top value of this Stack, which is the one that would be removed
	///						first.
	...
	/// @returns			{any|undefined}
	/// @description		Return the bottom value of this Stack, which is the one that would be
	///						removed last.
	///						Returns {undefined} if this Stack does not exists or is empty.
   ...
   #region <Execution>
	...
	/// @description		Remove any number of values from this Stack and return them. If more than
   ...
   #region <Conversion>
	...
	/// @description		Add values from the specified array to this Stack, starting from either
	///						the start of the array or its end.
