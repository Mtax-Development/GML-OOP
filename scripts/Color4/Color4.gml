...
/// @description		Constructs a Container for four colors. Each color corresponds to respective
///						corner of a rectangular Shape:
//						- color1: X1 Y1
//						- color2: X2 Y1
//						- color3: X2 Y2
//						- color4: X1 Y2
...
//  @feather	ignore all
{
  #region [Methods]
   #region <Management>
	...
	{
		return ((is_real(color1)) and (is_real(color2)) and (is_real(color3)) and (is_real(color4)));
	}
   ...
   #region <Getters>
	...
	///						color or respective values of the specified Color4. Those values can be
   ...
   #region <Setters>
	...
	static set = function(_color1 = color1, _color2 = color2, _color3 = color3, _color4 = color4)
	{
		color1 = _color1;
		color2 = _color2;
		color3 = _color3;
  ...
  #region [Static Constructions]
	...
	static white = new Color4(c_white, c_white, c_white, c_white);
	static black = new Color4(c_black, c_black, c_black, c_black);
