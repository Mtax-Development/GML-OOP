...
//  @feather	ignore all
{
  ...
  #region [Static Constructions]
	...
	static passthrough = new VertexFormat(vertex_format_add_position, vertex_format_add_color,
										  vertex_format_add_texcoord);
	static passthrough3D = new VertexFormat(vertex_format_add_position_3d, vertex_format_add_normal,
											vertex_format_add_texcoord, vertex_format_add_color);
