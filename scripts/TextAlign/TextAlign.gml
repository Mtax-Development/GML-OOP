...
//						   The first array position will be set to the x property and the second array
//						   position will be set to y property.
...
//  @feather	ignore all
{
  #region [Methods]
   #region <Management>
	...
	{
		return (((x == fa_left) or (x == fa_center) or (x == fa_right)) and ((y == fa_top) or
				(y == fa_middle) or (y == fa_bottom)));
	}
