...
//  @feather	ignore all
{
  ...
  #region [Elements]
	...
	/// @argument			object {handle:object}
	/// @argument			location? {Vector2}
	/// @description		Container constructor for properties of instances added to Room before its
	///						activation.
	//						
	//						Construction types:
	//						- New element
	...
	function AddedInstance() constructor
	{
	  #region [[Methods]]
	   ...
	   #region <<Conversion>>
		...
		/// @description		Create a string representing this constructor.
		///						Overrides the string() conversion.
		///						Content will be represented with the properties of this instance.
