	...
	#region [Methods]
				...
				if (argument_count > 0)
				{
					...
					else if (is_instanceof(argument[0], Rectangle))
					{
						...
						if (is_instanceof(_rectangle.location, Vector4))
						{
							...
							location = new Vector4(_rectangle.location.x1, _center_y,
												   _rectangle.location.x2, _center_y);
		...
		#region <Getters>
												 ...
												 _startWithCenter = false)
			{
				...
				try
				{
					var _angle = point_direction(_location.x1, _location.y1, _location.x2,
												 _location.y2);
					...
					var _location_bottomLeft = [(_location.x1 - lengthdir_x(_size_half, _angle_side)),
												(_location.y1 -
												 lengthdir_y(_size_half, _angle_side))];
					var _location_bottomRight = [(_location.x2 -
												  lengthdir_x(_size_half, _angle_side)),
												 (_location.y2 -
												  lengthdir_y(_size_half, _angle_side))];
					...
					if ((_outline) or (_outline == all))
					{
						...
						var _outline_outerTopRight = [(_location_topRight[0] + _offset_outline[0] +
													  ...
													  _offset_outline_side[1])];
						var _outline_outerBottomLeft = [(_location_bottomLeft[0] -
														 _offset_outline[0] -
														 _offset_outline_side[0]),
														(_location_bottomLeft[1] -
														 _offset_outline[1] -
														 _offset_outline_side[1])];
						var _outline_outerBottomRight = [(_location_bottomRight[0] +
														  _offset_outline[0] -
														  _offset_outline_side[0]),
														 (_location_bottomRight[1] +
														  _offset_outline[1] -
														  _offset_outline_side[1])];
						var _outline_outerTopInnerLeft = [(_location_topLeft[0] +
														   _offset_outline_side[0]),
														  (_location_topLeft[1] +
														   _offset_outline_side[1])];
						...
						var _outline_outerBottomInnerLeft = [(_location_bottomLeft[0] -
															 ...
															 (_location_bottomLeft[1] -
															  _offset_outline_side[1])];
						var _outline_innerBottomOuterLeft = [(_location_bottomLeft[0] -
															  _offset_outline[0]),
															 (_location_bottomLeft[1] -
															  _offset_outline[1])];
						var _outline_outerBottomInnerRight = [(_location_bottomRight[0] -
															  ...
															  (_location_bottomRight[1] -
															   _offset_outline_side[1])];
						var _outline_innerBottomOuterRight = [(_location_bottomRight[0] +
															   _offset_outline[0]),
															  (_location_bottomRight[1] +
															   _offset_outline[1])];
		...
		#region <Conversion>
											 ...
											 _vertexBuffer)
			{
				...
				try
				{
					...
					var _primitive = self.getPrimitiveRenderData(_location, _size, _fill_color,
